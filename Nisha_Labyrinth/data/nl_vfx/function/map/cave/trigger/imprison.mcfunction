...
execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon vindicator ~2 ~ ~ {Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["NL","nl_vfx","vind"],HandItems:[{id:"minecraft:diamond_axe",count:1b,components:{"minecraft:item_model":"custom/imprison/staff"}},{}]}
execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon vindicator ~-2 ~ ~ {Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["NL","nl_vfx","vind"],HandItems:[{id:"minecraft:diamond_axe",count:1b,components:{"minecraft:item_model":"custom/imprison/staff"}},{}]}

#execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon vindicator ~2 ~ ~ {Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["NL","nl_vfx","vind"]}
#execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon vindicator ~-2 ~ ~ {Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["NL","nl_vfx","vind"]}

execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon item_display ~1 ~ ~1 {Silent:1b,Tags:["nl_vfx","NL","vind"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1f,0f],scale:[2f,2f,2f]},item:{id:"minecraft:diamond_axe",count:1b,components:{"minecraft:item_model":"custom/imprison/staff"}}}
execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon item_display ~-1 ~ ~-1 {Silent:1b,Tags:["nl_vfx","NL","vind"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1f,0f],scale:[2f,2f,2f]},item:{id:"minecraft:diamond_axe",count:1b,components:{"minecraft:item_model":"custom/imprison/staff"}}}
execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon item_display ~ ~ ~ {Silent:1b,Tags:["nl_vfx","NL","vind","imp0"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,1f,0f],scale:[2f,2f,2f]},item:{id:"minecraft:diamond_axe",count:1b,components:{"minecraft:item_model":"custom/imprison/imprison0"}}}
