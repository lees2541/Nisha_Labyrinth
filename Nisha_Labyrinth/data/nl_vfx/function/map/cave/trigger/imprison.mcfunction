...
execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon vindicator ~2 ~ ~ {Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["NL","nl_vfx","vind"],HandItems:[{id:"minecraft:diamond_axe",Count:1b,tag:{CustomModelData:80001}},{}]}
execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,tag=imp_arm,limit=1] at @s run summon vindicator ~-2 ~ ~ {Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["NL","nl_vfx","vind"],HandItems:[{id:"minecraft:diamond_axe",Count:1b,tag:{CustomModelData:80001}},{}]}
