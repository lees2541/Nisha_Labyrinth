...
execute as @e[type=armor_stand,tag=coordinate,tag=NL,tag=imprison,tag=nl_vfx,limit=1] at @s run playsound minecraft:imprison_choir master @p 
...
schedule function nl_vfx:map/cave/trigger/imprison1 20t append
...
#summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Tags:["coordinate","NL","imprison","nl_vfx"]} (좌표 아머스탠드 소환)
#summon armor_stand ~ ~ ~ {Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["nl_vfx","NL","coordinate","imprison"]} (투명 아머스탠드)