...
execute as @n[type=wolf,tag=hunter,tag=pet,tag=NL] if data entity @s angry_at unless data entity @s active_effects[{id:"minecraft:speed"}] at @s run function nl_char:char_functions/roamer/hunter/skill/skill3/stop_chasing
