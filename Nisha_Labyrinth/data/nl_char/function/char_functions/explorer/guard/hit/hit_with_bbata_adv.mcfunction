...
execute at @s run playsound minecraft:guard_bbadda player @a ^ ^ ^0.3 1 0.85 0.4
...
execute if function #nl_system:load_player_info run function nl_char:char_functions/explorer/guard/status/remove/remove_bat_ready with storage nl:buffer player