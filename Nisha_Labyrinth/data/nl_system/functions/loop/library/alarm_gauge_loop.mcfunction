...
execute if score #library NL_lib_alam matches 301..400 run bossbar set nl:lib_alarm_gauge color green
...
#execute if score #library NL_lib_alarm_status matches 0 if score #library NL_lib_alarm_gauge matches 1000.. run advancement grant @a[team=roamer] only nishalabyrinth:system/library/alarm_red_gk
#execute if score #library NL_lib_alarm_status matches 0 if score #library NL_lib_alarm_gauge matches 1000.. run advancement grant @a[team=explorer,advancements={nishalabyrinth:system/location/in_the_lib=true}] only nishalabyrinth:system/library/alarm_red
