...
say 배회자 생명석캤덩
advancement grant @a[tag=NL,tag=roamer] only nl_system:systems/actions/mined/mined_lifestone
advancement revoke @a[tag=NL,tag=roamer] only nl_system:systems/actions/mined/mined_lifestone
