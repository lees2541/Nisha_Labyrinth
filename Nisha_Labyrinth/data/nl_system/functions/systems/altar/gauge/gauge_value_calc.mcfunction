...
execute if data storage nl:in_game status.altar{mode:1} if score #altar NL_altar_gauge <= #var NL_altar_gauge run function nl_system:systems/altar/bossbar/altar_ready
