bossbar set nl:lib_alarm_gauge players @a[advancements={nishalabyrinth:system/location/in_the_lib=true},predicate=nishalabyrinth:system/library/in_the_library]
