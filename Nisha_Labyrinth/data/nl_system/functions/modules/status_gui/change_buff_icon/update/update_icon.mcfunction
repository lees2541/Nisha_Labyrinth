#> nl_system:modules/status_gui/change_buff_icon/update/update_icon
...
$execute if data storage nl:in_game player[{id:$(id)}].icons.lf_slot[0] run return run function nl_system:modules/status_gui/change_buff_icon/change_lifestone_icon with storage nl:in_game player[{id:$(id)}].icons.lf_slot[0]
