#> nl_system:modules/status_gui/change_lifestone_icon/update/input_storage\
...
$data modify storage nl:in_game player[{id:$(id)}].icons.lf_slot prepend from storage nl:buffer icon
