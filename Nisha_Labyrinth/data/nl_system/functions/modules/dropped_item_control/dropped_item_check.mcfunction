...
execute if entity @s[nbt={Item:{tag:{NL:1b}}},nbt=!{Item:{tag:{drop:1b}}},nbt=!{Item:{tag:{drop:0b}}}] run function nl_system:modules/dropped_item_control/back_to_owner with entity @s Item
