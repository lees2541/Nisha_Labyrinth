...
$execute at @s facing entity @e[type=marker,tag=area,tag=$(tag),limit=1,sort=nearest] eyes run tp @s ^ ^ ^0.2 facing entity @e[type=marker,tag=area,tag=$(tag),limit=1,sort=nearest] eyes
