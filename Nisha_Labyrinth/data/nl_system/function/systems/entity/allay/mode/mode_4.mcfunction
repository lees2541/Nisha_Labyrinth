...
execute at @s facing entity @e[type=marker,tag=NL,tag=area1,tag=area,limit=1,sort=nearest] eyes positioned ^ ^ ^0.15 run tp @s ~ ~ ~ facing entity @e[type=marker,tag=NL,tag=area1,tag=area,limit=1,sort=nearest] eyes
