...
execute as @e[type=vindicator,tag=tracer,limit=1,sort=nearest] at @s run data modify entity @s angry_at set from entity @a[sort=nearest,limit=1,tag=NL] UUID
