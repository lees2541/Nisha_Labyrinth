...
execute as @e[type=wandering_trader,tag=patrol,scores={NL_mode=0},nbt={OnGround:1b}] unless data entity @s wander_target run data modify entity @s wander_target set from entity @s Passengers[{id:"minecraft:marker"}].data.route[0]
