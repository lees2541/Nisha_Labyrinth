say change
execute if items entity @s player.cursor diamond_hoe[custom_data~{NL:1b,offhand:1b}] if items entity @s weapon.offhand *[!minecraft:custom_data~{NL:1b,offhand:1b}] run item replace entity @s player.cursor from entity @s weapon.offhand
clear @s diamond_hoe[custom_data~{NL:1b,offhand:1b}]
