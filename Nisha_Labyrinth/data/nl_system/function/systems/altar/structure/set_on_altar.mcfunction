...
execute on attacker if entity @s[nbt={Inventory:[{id:"minecraft:redstone",tag:{NL:1b,redstone:1b}}]}] run return run clear @s redstone[minecraft:custom_data={NL:1b,redstone:1b}] 1
