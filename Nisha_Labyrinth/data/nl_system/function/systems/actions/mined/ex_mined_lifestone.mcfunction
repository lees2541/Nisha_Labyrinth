...
execute as @a[tag=explorer,tag=NL] run function nl_system:modules/storage/scoreboard/operation/resource_count/calc_resource {resource:"lifestone",operator:"add",operand:"1"}
