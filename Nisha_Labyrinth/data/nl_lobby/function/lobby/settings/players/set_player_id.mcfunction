...
execute if score @s NL_player_id matches 1 run attribute @s minecraft:luck base set 1
...
execute if score @s NL_player_id matches 2 run attribute @s minecraft:luck base set 2
...
execute if score @s NL_player_id matches 3 run attribute @s minecraft:luck base set 3
