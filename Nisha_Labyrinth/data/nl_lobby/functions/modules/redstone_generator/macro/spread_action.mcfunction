...
execute as @e[type=marker,tag=!origin,tag=spread,limit=1,tag=redstone_gen,tag=!redstone,sort=random] at @s run function nl_lobby:modules/redstone_generator/macro/place_redstone
