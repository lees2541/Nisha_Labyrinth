...
execute if score @s NL_player_id matches 2 run scoreboard players reset player1 NL_status_gui

execute if score @s NL_player_id matches 3 run scoreboard players set @s NL_status_gui 7
execute if score @s NL_player_id matches 3 run scoreboard players reset player1 NL_status_gui
